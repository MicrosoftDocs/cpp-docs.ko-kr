---
description: _Interlockedbittestandset 내장 함수에 대해 자세히 알아보세요.
...
ARM 및 ARM64 프로세서에서는 `_acq` `_rel` 임계 영역의 시작 및 끝과 같이 획득 및 해제 의미 체계에 및 접미사와 함께 내장 함수를 사용 합니다. `_nf`("No fence") 접미사가 포함 된 ARM 내장 함수는 메모리 장벽으로 작동 하지 않습니다.
