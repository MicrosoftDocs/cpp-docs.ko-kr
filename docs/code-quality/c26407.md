---
title: C26407
description: Visual Studio C++ Core Guidelines 코드 분석 경고 C26407에 대 한 참조입니다.
ms.date: 08/18/2020
ms.topic: conceptual
f1_keywords:
- C26407
...
- 경고 수를 줄이기 위해 코드 분석은 소유자 포인터에 대해서만이 패턴을 검색 합니다. 따라서 먼저 소유자를 올바르게 표시 해야 합니다. 이러한 시나리오를 지원 하기 위해 고객의 Visual Studio c + + [개발자 커뮤니티](https://aka.ms/feedback/suggest?space=62) 에 대 한 피드백을 받으면 원시 포인터를 포함 하도록 쉽게 확장할 수 있습니다.
