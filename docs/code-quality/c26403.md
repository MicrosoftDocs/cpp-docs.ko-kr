---
description: '자세히 알아보기: C26403 RESET_OR_DELETE_OWNER'
title: C26403
ms.date: 07/21/2017
ms.topic: conceptual
f1_keywords:
...
자세한 내용은 [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md#r-resource-management)를 참조 하세요.
...
- 이 검사는 코드 분석을 차단 하지 않기 위해 복잡 한 함수를 취소할 수 있습니다. 일반적으로 함수의 복잡성은 적절 한 임계값에서 유지 관리 해야 합니다. 명확 하 게 요구 되는 경우 C++ Core Guidelines 모듈에 로컬 복잡성 검사를 추가 하는 것을 고려할 수 있습니다. 이 제한은 데이터 흐름에 중요 한 다른 규칙에 적용 됩니다.
