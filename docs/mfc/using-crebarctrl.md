---
description: '자세히 알아보기: Cre Ctrl 사용'
title: CReBarCtrl 사용
ms.date: 11/19/2018
helpviewer_keywords:
...
![밴드가 2개 있는 rebar 컨트롤](../mfc/media/vc4ruz1.gif "밴드가 2개 있는 rebar 컨트롤")
...
- [Rebar 컨트롤과 함께 이미지 목록 사용](../mfc/using-an-image-list-with-a-rebar-control.md)

- [Rebar 컨트롤이 있는 대화 상자 모음 사용](../mfc/using-a-dialog-bar-with-a-rebar-control.md)
