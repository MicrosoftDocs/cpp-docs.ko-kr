...
|제목|설명|
|-----------|-----------------|
|[MFC 데스크톱 응용 프로그램](mfc-desktop-applications.md)|Microsoft Foundation 클래스는 Win32를 통해 씬 개체 지향 래퍼를 제공하여 C++에서 GUI 애플리케이션을 신속하게 개발할 수 있도록 합니다.|
