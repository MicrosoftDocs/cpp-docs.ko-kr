---
description: '자세히 알아보기: 속성 시트 (MFC)'
title: 속성 시트(MFC)
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97248842"
---
# <a name="property-sheets-mfc"></a>속성 시트(MFC)

이 문서 모음에서는 MFC 애플리케이션에서 속성 시트에 대한 지원을 구현하는 방법에 대해 설명합니다. 탭 대화 상자라고도 부르는 속성 시트는 대화 상자에서 대량의 컨트롤을 관리하는 방법을 제공합니다. 속성 시트에는 개별 대화 상자 템플릿 리소스를 기준으로 하는 속성 페이지가 포함됩니다. 대화 상자의 컨트롤을 논리적 그룹으로 나누고, 각 그룹을 고유한 속성 페이지에 넣을 수 있습니다.
...
- 속성 [시트에 컨트롤 추가](../mfc/adding-controls-to-a-property-sheet.md) (속성 페이지와 반대)

- [속성 시트와 프로그램 간에 데이터 교환](../mfc/exchanging-data.md)

- [모덜리스 속성 시트 만들기](../mfc/creating-a-modeless-property-sheet.md)

- [적용 단추 처리](../mfc/handling-the-apply-button.md)

- [마법사로 서의 속성 시트](../mfc/property-sheets-as-wizards.md)
