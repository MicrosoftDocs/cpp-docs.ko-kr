---
description: '자세히 알아보기: CListCtrl 클래스'
title: CListCtrl 클래스
ms.date: 06/13/2019
f1_keywords:
- CListCtrl
...
*iCount*<br/>
컨트롤에 표시 되는 항목의 수입니다. -1을 전달 하 여 현재 컨트롤에 있는 총 항목 수를 사용 합니다.
...
*nItem*<br/>
상태를 설정할 항목의 인덱스입니다. -1을 전달 하 여 모든 항목에 상태 변경 내용을 적용 합니다.
