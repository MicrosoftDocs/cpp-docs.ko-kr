...
- **생성된 클래스**
   ...
   **>** 또는 **>>** 단추를 사용하여 추가한 인터페이스에서 생성할 클래스 이름을 지정합니다. 이 상자를 클릭 하 **여 클래스를** 선택한 다음 위쪽 또는 아래쪽 키를 사용 하 여 클래스 상자에서 각 클래스 이름 및 마법사가 생성 하는 **파일** 상자에서 파일 이름 ( **마침** 을 클릭할 때)을 볼 수 있습니다. 이 상자에서는 한 번에 하나의 클래스만 선택할 수 있습니다.
