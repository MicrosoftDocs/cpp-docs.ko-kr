---
description: '자세한 정보: CMFCTabCtrl 클래스'
...
|[CMFCTabCtrl:: Create](#create)|탭 컨트롤을 만들고이를 개체에 연결 `CMFCTabCtrl` 합니다.|
...
도킹 컨트롤 막대로 탭 창을 만드는 방법에 대 한 예제는 [CTabbedPane 클래스](../../mfc/reference/ctabbedpane-class.md)를 참조 하세요. `CMFCTabCtrl`도킹 되지 않은 컨트롤로를 사용 하려면 개체를 만든 `CMFCTabCtrl` 다음 [Cmfctabctrl:: create](#create)를 호출 합니다.
...
다음 예제에서는 클래스에서 다양 한 메서드를 사용 하 여 개체를 구성 하는 방법을 보여 줍니다 `CMFCTabCtrl` `CMFCTabCtrl` . 이 예에서는 탭을 추가 하 고, 활성 탭에서 닫기 단추를 표시 하 고, 편집 가능한 탭 레이블을 사용 하도록 설정 하 고, 탭 창 레이블의 팝업 메뉴를 표시 하는 방법을 설명 합니다. 이 예제는 [상태 컬렉션 샘플](../../overview/visual-cpp-samples.md)의 일부입니다.
...
탭 컨트롤을 만들고이를 개체에 연결 `CMFCTabCtrl` 합니다.
...
다음 예제에서는 클래스에서 메서드를 사용 하는 방법을 보여 줍니다 `Create` `CMFCTabCtrl` . 이 예제는 [상태 컬렉션 샘플](../../overview/visual-cpp-samples.md)의 일부입니다.
...
## <a name="cmfctabctrlenabletabdocumentsmenu"></a><a name="enabletabdocumentsmenu"></a> CMFCTabCtrl:: Enabletab문서 메뉴
...
`CMFCTabCtrl::ResizeMode`탭 컨트롤의 크기를 조정할 수 있는 방법을 지정 하는 열거형 값 중 하나입니다. 사용할 수 있는 값 목록은 [Cmfctabctrl:: SetResizeMode](#setresizemode) 메서드의 설명 섹션을 참조 하세요.
...
## <a name="cmfctabctrlistabdocumentsmenu"></a><a name="istabdocumentsmenu"></a> CMFCTabCtrl:: Istab문서 메뉴
...
이 탭은 일반적으로 탭을 삽입 하 고 활성 상태로 만들 때 새 탭 창에서 가져옵니다. `CMFCTabCtrl::m_bEnableActivate`원래 포커스를 유지 하려면 멤버 변수를 FALSE로 설정 합니다. 기본값은 TRUE입니다.
...
*Style* 매개 변수의 값은 다음 열거형 중 하나일 수 있습니다 `CMFCTabCtrl::Style` .
...
## <a name="cmfctabctrlondragenter"></a><a name="ondragenter"></a> CMFCTabCtrl:: System.windows.uielement.ondragenter
...
기본적으로이 메서드 `CMFCTabCtrl::OnDragOver` 는 항상 DROPEFFECT_NONE을 반환 하는를 호출 합니다.

## <a name="cmfctabctrlondragover"></a><a name="ondragover"></a> CMFCTabCtrl:: System.windows.uielement.ondragover
...
## <a name="cmfctabctrlonshowtabdocumentsmenu"></a><a name="onshowtabdocumentsmenu"></a> CMFCTabCtrl:: Onshowtab문서 메뉴
...
## <a name="cmfctabctrlsetimagelist"></a><a name="setimagelist"></a> CMFCTabCtrl:: Seon Agelist
...
진행 `CMFCTabCtrl::ResizeMode` 탭 컨트롤의 크기를 조정할 수 있는 방법을 지정 하는 열거형 값 중 하나입니다. 가능한 값 목록은 설명의 표를 참조 하십시오.

### <a name="remarks"></a>설명

*System.windows.resizemode>* 매개 변수는 다음 열거형 값 중 하나일 수 있습니다 `ResizeMode` .
