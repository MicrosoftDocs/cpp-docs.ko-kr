---
description: '에 대 한 자세한 정보: 배포 Visual C++'
title: Visual C++의 개발
ms.date: 05/11/2018
helpviewer_keywords:
...
- *재배포 가능 병합 모듈* (.msm 파일)은 특정 라이브러리를 배포 하는 데 사용할 수 있으며 응용 프로그램의 Windows Installer (.msi) 파일에 포함할 수 있습니다.
