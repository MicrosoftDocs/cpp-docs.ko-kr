...
- 새 파일에서 **이진 편집기** 를 열려면 메뉴 **파일** 새 파일로 이동 하 여  >    >  편집 하려는 파일 유형을 선택한 다음 **열기** 단추 옆의 드롭다운 화살표를 선택 하 고 이진 편집기 **로 열기** 를 선택  >  합니다.

- 기존 파일에서 **이진 편집기** 를 열려면 메뉴 **파일** 열기로 이동 하 여  >    >  편집 하려는 파일을 선택한 다음 **열기** 단추 옆의 드롭다운 화살표를 선택 하 고 이진 편집기 **로 열기** 를 선택  >  합니다.
...
1. 메뉴로 이동 하 여 찾기를 **편집**  >  [](/visualstudio/ide/reference/find-command)합니다.
