...
1. **이미지 편집기** 도구 모음을 사용 하거나 메뉴 **이미지** 도구로 이동 하 여  >   **채우기** 도구를 선택 합니다.
...
1. **이미지 편집기** 도구 모음을 사용 하거나 메뉴 **이미지** 도구로 이동 하 여  >   **색 선택** 도구를 선택 합니다.
