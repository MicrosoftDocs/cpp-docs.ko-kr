---
description: '자세히 알아보기: 방법: 컨트롤 레이아웃 (c + +)'
...
- 컨트롤의 크기를 동일 하 게 만들려면 크기를 조정 하려는 컨트롤을 선택 하 고 메뉴 **형식** 을  >  **같은 크기로** 이동한 다음, **높이** 또는 **너비** 중 하나를 선택 합니다. 
...
- 균일 한 공간 컨트롤을 만들려면 다시 정렬할 컨트롤을 선택 합니다. 메뉴 **형식** 공간을 균등 하 게 이동 하  >   고 다음 간격 맞춤 중 하나를 선택 합니다.
...
- 컨트롤을 가운데에 표시 하려면 다시 정렬할 컨트롤이 나 컨트롤을 선택 합니다.   >  **대화 상자에서** 메뉴 형식 센터로 이동 하 고 다음 배열 중 하나를 선택 합니다.
