...
설치 프로젝트를 만드는 방법에 대 한 지침은 설치한 Visual Studio 버전에 따라 다릅니다. 기본 설정된 버전의 Visual Studio에 대한 설명서를 보려면 **버전** 선택기 컨트롤을 사용하세요. 이 페이지의 목차 맨 위에 있습니다.
...
1. 메뉴 모음에서 **파일** >**새로 만들기** >**프로젝트** 를 선택하여 **새 프로젝트 만들기** 대화 상자를 엽니다.
   ...
   ![MFC 앱 프로젝트](media/vs2019-mfc-app-new-project.png "새 MFC 앱")

1. 대화 상자 위쪽에서 `MFC` 검색 상자에를 입력 한 다음 결과 목록에서 **MFC 앱** 을 선택 합니다. 표시 되지 않는 경우에는 Windows 시작 메뉴에서 Visual Studio 설치 관리자 프로그램을 시작 하 고 **c + + 데스크톱 개발 워크 로드** 타일을 클릭 해야 합니다. **개별 구성 요소** 에서 MFC 구성 요소가 선택 되어 있는지 확인 합니다.
...
1. 메뉴 모음에서 **파일**  >  **새로 만들기**  >  **프로젝트** 를 선택 하 여 **새 프로젝트** 대화 상자를 엽니다. 그런 다음 대화 상자의 왼쪽 창에서 **설치 된**  >  **기타 프로젝트 형식** 노드를 확장 하 고 **Visual Studio 설치 관리자** 를 선택 합니다. 가운데 창에서 **설치 프로젝트** 를 선택합니다.
