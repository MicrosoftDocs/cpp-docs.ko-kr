...
|[컴파일러 오류 C2730](compiler-error-c2730.md)|'*class*': 자체의 기본 클래스가 될 수 없습니다.|
...
|[컴파일러 오류 C2767](compiler-error-c2767.md)|관리 되는/WinRT 배열 차원이 일치 하지 않습니다 *. 제공 된* *숫자* 인수가 필요 합니다.|
