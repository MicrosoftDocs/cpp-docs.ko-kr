...
해당하는 [활동](activity.md) 기본 클래스에서 상속된 멤버와 함께 `LinkerPass` 클래스에는 다음 멤버가 포함됩니다.
...
*event*\
[PASS1](../event-table.md#pass1) 또는 [PASS2](../event-table.md#pass2) 이벤트입니다.
