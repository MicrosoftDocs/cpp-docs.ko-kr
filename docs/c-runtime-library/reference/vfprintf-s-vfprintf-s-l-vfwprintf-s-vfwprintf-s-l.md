---
description: '자세한 정보: vfprintf_s, _vfprintf_s_l, vfwprintf_s, _vfwprintf_s_l'
...
**vfwprintf_s** 은 **vfprintf_s** 의 와이드 문자 버전입니다. 두 함수는 스트림이 ANSI 모드에서 열리는 경우 동일 하 게 동작 합니다. **vfprintf_s** 는 현재 유니코드 스트림으로의 출력을 지원 하지 않습니다.
