---
description: '다음에 대 한 자세한 정보: strrev, wcsrev'
title: strrev, wcsrev
ms.date: 12/16/2019
api_name:
- strrev
...
ms.locfileid: "97209427"
---
# <a name="strrev-wcsrev"></a>strrev, wcsrev

Microsoft 전용 함수 이름 및는 `strrev` `wcsrev` [_strrev 및 _wcsrev](strrev-wcsrev-mbsrev-mbsrev-l.md) 함수에서 사용 되지 않는 별칭입니다. 기본적으로 [컴파일러 경고 (수준 3) C4996](../../error-messages/compiler-warnings/compiler-warning-level-3-c4996.md)를 생성 합니다. 이름은 구현 관련 이름에 대해 표준 C 규칙을 따르지 않으므로 사용 되지 않습니다. 그러나 함수는 여전히 지원 됩니다.
