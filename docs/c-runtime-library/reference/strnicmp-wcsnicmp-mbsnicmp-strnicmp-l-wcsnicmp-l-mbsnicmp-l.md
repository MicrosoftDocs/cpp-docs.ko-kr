---
description: '자세한 정보: _strnicmp, _wcsnicmp, _mbsnicmp, _strnicmp_l, _wcsnicmp_l, _mbsnicmp_l'
...
매개 변수 유효성 검사 오류 시 이러한 함수는 및에 정의 된 **_NLSCMPERROR** 를 \<string.h> 반환 \<mbstring.h> 합니다.
