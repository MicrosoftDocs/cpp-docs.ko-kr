---
description: '다음에 대 한 자세한 정보: __w64'
title: __w64
ms.date: 05/07/2019
f1_keywords:
- __w64_cpp
...
> [!IMPORTANT]
> [/Wp64](../build/reference/wp64-detect-64-bit-portability-issues.md) 컴파일러 옵션 및 **`__w64`** 키워드는 Visual Studio 2010에서 더 이상 사용 되지 않으며 Visual Studio 2013 Visual Studio 2013부터 제거 되었습니다. `/Wp64`명령줄에서 컴파일러 옵션을 사용 하는 경우 컴파일러에서 경고 D9002 Command-Line 발생 합니다. **`__w64`** 키워드는 자동으로 무시 됩니다. 64 비트 이식성 문제를 검색 하기 위해이 옵션과 키워드를 사용 하는 대신 64 비트 플랫폼을 대상으로 하는 Microsoft c + + 컴파일러를 사용 합니다. 자세한 내용은 [64 비트, x64 대상에 대 한 Visual C++ 구성](../build/configuring-programs-for-64-bit-visual-cpp.md)을 참조 하세요.
