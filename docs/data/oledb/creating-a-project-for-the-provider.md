---
description: '자세한 정보: 공급자에 대 한 프로젝트 만들기'
title: 공급자용 프로젝트 만들기
ms.date: 10/22/2018
helpviewer_keywords:
...
1. **프로젝트 형식** 창에서 **설치** 된  >    >  **MFC/ATL** 폴더 Visual C++를 클릭 합니다. **템플릿** 창에서 **ATL 프로젝트** 를 클릭 합니다.

    > [!NOTE]
    > 이전 버전의 Visual Studio에서는 **설치 된**  >  **템플릿**  >  **Visual C++**  >  **ATL** 에서 프로젝트 형식을 찾습니다.
