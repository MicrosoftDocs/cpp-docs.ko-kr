---
description: '자세히 알아보기: CAccessorBase 클래스'
...
[Releaseaccessors](#release) 를 먼저 호출 해야 합니다.
...
[CAccessorRowset:: Close](./caccessorrowset-class.md#close)에서 호출 됩니다.
