---
description: '자세히 알아보기: CEnumerator 클래스'
...
*ppMoniker*<br/>
제한이 현재 행의 표시 이름 ([Cenumeratoraccessor:: m_szParseName](./cenumeratoraccessor-class.md#szparsename))에서 구문 분석 된 모니커입니다.
