---
description: Is_object 클래스에 대해 자세히 알아보세요.
title: is_object 클래스
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "97323566"
---
# <a name="is_object-class"></a>is_object 클래스
...
형식 조건자의 인스턴스는 *Ty* 형식이 참조 형식, 함수 형식 또는 void 형식이 면 false이 고 `cv-qualified` , 그렇지 않으면 true입니다.
