...
## <a name="norm"></a><a name="norm"></a> 늦지
...
## <a name="polar"></a><a name="polar"></a> 극좌표 형
...
복소수 형식의 극좌표는 모듈러스 *r* 및 인수 *p* 를 제공 합니다. 이러한 매개 변수는 *a* = r  cos  \* *p* 및 *b*  =  *r* \* sin *p* 수식에 의해 실수 및 허수 데카르트 구성 요소 a와 b에 연결 됩니다.
