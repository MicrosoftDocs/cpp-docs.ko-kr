---
description: Is_abstract 클래스에 대해 자세히 알아보세요.
...
ms.locfileid: "97323889"
---
# <a name="is_abstract-class"></a>is_abstract 클래스
...
형식 조건자의 인스턴스는 *Ty* 형식이 하나 이상의 순수 가상 함수를 가진 클래스인 경우 true이 고 그렇지 않은 경우 false입니다.
