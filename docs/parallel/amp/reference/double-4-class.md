---
description: Double_4 클래스에 대해 자세히 알아보세요.
title: double_4 클래스
ms.date: 11/04/2016
f1_keywords:
...
|이름|설명|
|----------|-----------------|
|[double_4 생성자](#ctor)|오버로드됨. 기본 생성자는 0으로 모든 요소를 초기화 합니다.|
...
## <a name="size"></a><a name="double_4__size"></a> 크기가
