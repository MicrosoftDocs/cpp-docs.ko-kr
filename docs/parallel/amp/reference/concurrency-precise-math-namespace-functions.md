...
## <a name="fmod-function-c-amp"></a><a name="fmod"></a> fmod 함수 (C++ AMP)
...
*_Iptr*<br/>
제한이 부동 소수점 값으로의 정수 부분입니다 `_X` .

### <a name="return-value"></a>반환 값

의 부호 있는 소수 부분 `_X` 입니다.
...
*_Iptr*<br/>
부동 소수점 값으로의 정수 부분입니다 `_X` .

### <a name="return-value"></a>반환 값

의 부호 있는 소수 부분을 반환 합니다 `_X` .

## <a name="nan"></a><a name="nan"></a> n
...
## <a name="remainder"></a><a name="remainder"></a> 남은
...
*_Quo*<br/>
제한이 의 소수 부분 비트로 나눈 소수 자릿수 비트의 몫을 반환 하는 데 사용 되는 정수의 주소입니다 `_X` `_Y` .

### <a name="return-value"></a>반환 값

의 나머지를 `_X` 로 나눈 값을 반환 합니다 `_Y` .
...
[동시성::p recise_math 네임 스페이스](concurrency-precise-math-namespace.md)
