---
description: '자세히 알아보기: Concurrency:: graphics 네임 스페이스 열거형'
...
## <a name="address_mode-enumeration"></a><a name="address_mode"></a> address_mode 열거형
...
## <a name="filter_mode-enumeration"></a><a name="filter_mode"></a> filter_mode 열거형
