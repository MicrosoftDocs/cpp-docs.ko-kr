---
description: '자세히 알아보기: Concurrency::p recise_math 네임 스페이스'
...
ms.locfileid: "97297150"
---
# <a name="concurrencyprecise_math-namespace"></a>Concurrency::precise_math 네임스페이스

`precise_math`네임 스페이스의 함수는 C99 규격입니다. 각 함수의 단일 전체 자릿수와 배정밀도 버전이 모두 포함 되어 있습니다. 예를 들어 `acos` 은 배정밀도 버전이 고는 `acosf` 단 정밀도 버전입니다. 단 정밀도 함수를 비롯 한 이러한 함수에는 액셀러레이터에 대 한 확장 된 배정밀도 지원이 필요 합니다. [Accelerator:: supports_double_precision](accelerator-class.md#supports_double_precision) 을 사용 하 여 특정 액셀러레이터 키에서 이러한 함수를 실행할 수 있는지 확인할 수 있습니다.
...
|Name|설명|
|----------|-----------------|
|[acos](concurrency-precise-math-namespace-functions.md#acos)|오버로드됨. 인수의 아크코사인을 계산 합니다.|
...
|[asin](concurrency-precise-math-namespace-functions.md#asin)|오버로드됨. 인수의 아크사인을 계산 합니다.|
...
|[atan2](concurrency-precise-math-namespace-functions.md#atan2)|오버로드됨. _Y/_X의 아크탄젠트를 계산 합니다.|
...
|[ceil](concurrency-precise-math-namespace-functions.md#ceil)|오버로드됨. 인수의 최대값을 계산 합니다.|
...
|[cosh](concurrency-precise-math-namespace-functions.md#cosh)|오버로드됨. 인수의 하이퍼볼릭 코사인 값을 계산 합니다.|
...
|[exp](concurrency-precise-math-namespace-functions.md#exp)|오버로드됨. 인수의 밑이 e 인 지 수를 계산 합니다.|
|[exp10](concurrency-precise-math-namespace-functions.md#exp10)|오버로드됨. 인수의 밑이 10 인 지 수를 계산 합니다.|
|[exp10f](concurrency-precise-math-namespace-functions.md#exp10f)|인수의 밑이 10 인 지 수를 계산 합니다.|
|[exp2](concurrency-precise-math-namespace-functions.md#exp2)|오버로드됨. 인수의 밑이 2 인 지 수를 계산 합니다.|
...
|[fabs](concurrency-precise-math-namespace-functions.md#fabs)|오버로드됨. 인수의 절대 값을 반환 합니다.|
|[fabsf](concurrency-precise-math-namespace-functions.md#fabsf)|인수의 절대 값을 반환 합니다.|
|[fdim](concurrency-precise-math-namespace-functions.md#fdim)|오버로드됨. 인수의 양수 차이를 결정 합니다.|
|[fdimf](concurrency-precise-math-namespace-functions.md#fdimf)|인수의 양수 차이를 결정 합니다.|
|[평면](concurrency-precise-math-namespace-functions.md#floor)|오버로드됨. 인수의 바닥을 계산 합니다.|
|[floorf](concurrency-precise-math-namespace-functions.md#floorf)|인수의 바닥을 계산 합니다.|
|[fma](concurrency-precise-math-namespace-functions.md#fma)|오버로드됨. Compute (_X \* _Y) + _Z, 한 삼항 작업으로 반올림 됨|
|[fmaf](concurrency-precise-math-namespace-functions.md#fmaf)|Compute (_X \* _Y) + _Z, 한 삼항 작업으로 반올림 됨|
|[fmax](concurrency-precise-math-namespace-functions.md#fmax)|오버로드됨. 인수의 최대 숫자 값을 결정 합니다.|
|[fmaxf](concurrency-precise-math-namespace-functions.md#fmaxf)|인수의 최대 숫자 값을 결정 합니다.|
|[fmin](concurrency-precise-math-namespace-functions.md#fmin)|오버로드됨. 인수의 최소 숫자 값을 확인 합니다.|
|[fminf](concurrency-precise-math-namespace-functions.md#fminf)|인수의 최소 숫자 값을 확인 합니다.|
|[fmod 함수(C++ AMP)](concurrency-precise-math-namespace-functions.md#fmod)|오버로드됨. _X/_Y의 부동 소수점 나머지를 계산 합니다.|
...
|[frexp](concurrency-precise-math-namespace-functions.md#frexp)|오버로드됨. 의가 수와 지 수를 가져옵니다 _X|
...
|[isfinite](concurrency-precise-math-namespace-functions.md#isfinite)|오버로드됨. 인수에 유한 값이 있는지 여부를 확인 합니다.|
|[isinf](concurrency-precise-math-namespace-functions.md#isinf)|오버로드됨. 인수가 무한대 인지 여부를 확인 합니다.|
|[isnan](concurrency-precise-math-namespace-functions.md#isnan)|오버로드됨. 인수가 NaN 인지 여부를 확인 합니다.|
|[isnormal](concurrency-precise-math-namespace-functions.md#isnormal)|오버로드됨. 인수가 정상인지 여부를 결정합니다.|
|[ldexp](concurrency-precise-math-namespace-functions.md#ldexp)|오버로드됨. 가 수 및 지 수에서 실수를 계산 합니다.|
...
|[로깅할](concurrency-precise-math-namespace-functions.md#log)|오버로드됨. 인수의 밑이 e 인 로그를 계산 합니다.|
|[log10](concurrency-precise-math-namespace-functions.md#log10)|오버로드됨. 인수의 밑이 10 인 로그를 계산 합니다.|
...
|[log2](concurrency-precise-math-namespace-functions.md#log2)|오버로드됨. 인수의 밑이 2 인 로그를 계산 합니다.|
...
|[modf](concurrency-precise-math-namespace-functions.md#modf)|오버로드됨. _X을 소수 부분과 정수 부분으로 분할 합니다.|
...
|[nextafter](concurrency-precise-math-namespace-functions.md#nextafter)|오버로드됨. 다음 표현 가능한 값을 함수 형식에서 _X 후의 방향에 따라 결정 _Y|
|[nextafterf](concurrency-precise-math-namespace-functions.md#nextafterf)|다음 표현 가능한 값을 함수 형식에서 _X 후의 방향에 따라 결정 _Y|
|[파이](concurrency-precise-math-namespace-functions.md#phi)|오버로드됨. 인수의 누적 분포 함수를 반환 합니다.|
|[phif](concurrency-precise-math-namespace-functions.md#phif)|인수의 누적 분포 함수를 반환 합니다.|
|[pow](concurrency-precise-math-namespace-functions.md#pow)|오버로드됨. _Y의 거듭제곱으로 발생 한 _X 계산 합니다.|
|[powf](concurrency-precise-math-namespace-functions.md#powf)|_Y의 거듭제곱으로 발생 한 _X 계산 합니다.|
|[probit](concurrency-precise-math-namespace-functions.md#probit)|오버로드됨. 인수의 역 누적 분포 함수를 반환 합니다.|
|[probitf](concurrency-precise-math-namespace-functions.md#probitf)|인수의 역 누적 분포 함수를 반환 합니다.|
|[rcbrt](concurrency-precise-math-namespace-functions.md#rcbrt)|오버로드됨. 인수의 큐브 루트의 역을 반환 합니다.|
|[rcbrtf](concurrency-precise-math-namespace-functions.md#rcbrtf)|인수의 큐브 루트의 역을 반환 합니다.|
|[남은](concurrency-precise-math-namespace-functions.md#remainder)|오버로드됨. 나머지 _X REM _Y를 계산합니다.|
|[remainderf](concurrency-precise-math-namespace-functions.md#remainderf)|나머지 _X REM _Y를 계산합니다.|
|[remquo](concurrency-precise-math-namespace-functions.md#remquo)|오버로드됨. _X REM _Y와 같은 나머지를 계산 합니다. 는 정수 몫 _X/_Y의 하 한 23 비트를 계산 하 고 해당 값에 _X/_Y와 동일한 부호를 제공 합니다. _Quo에서 가리키는 정수에이 부호 있는 값을 저장 합니다.|
...
|[둥근](concurrency-precise-math-namespace-functions.md#round)|오버로드됨. _X를 가장 가까운 정수로 반올림 합니다.|
|[roundf](concurrency-precise-math-namespace-functions.md#roundf)|_X를 가장 가까운 정수로 반올림 합니다.|
|[rsqrt](concurrency-precise-math-namespace-functions.md#rsqrt)|오버로드됨. 인수의 제곱근의 역을 반환 합니다.|
...
|[사인](concurrency-precise-math-namespace-functions.md#sin)|오버로드됨. 인수의 사인 값을 계산 합니다.|
|[sincos](concurrency-precise-math-namespace-functions.md#sincos)|오버로드됨. _X의 사인 및 코사인 값을 계산 합니다.|
...
|[sinh](concurrency-precise-math-namespace-functions.md#sinh)|오버로드됨. 인수의 하이퍼볼릭 사인 값을 계산 합니다.|
|[sinhf](concurrency-precise-math-namespace-functions.md#sinhf)|인수의 하이퍼볼릭 사인 값을 계산 합니다.|
|[sinpi](concurrency-precise-math-namespace-functions.md#sinpi)|오버로드됨. Pi _X의 사인 값을 계산 합니다. \*|
|[sinpif](concurrency-precise-math-namespace-functions.md#sinpif)|Pi _X의 사인 값을 계산 합니다. \*|
...
|[tan](concurrency-precise-math-namespace-functions.md#tan)|오버로드됨. 인수의 탄젠트 값을 계산 합니다.|
|[tanf](concurrency-precise-math-namespace-functions.md#tanf)|인수의 탄젠트 값을 계산 합니다.|
|[tanh](concurrency-precise-math-namespace-functions.md#tanh)|오버로드됨. 인수의 하이퍼볼릭 탄젠트 값을 계산 합니다.|
...
|[trunc](concurrency-precise-math-namespace-functions.md#trunc)|오버로드됨. 인수를 정수 구성 요소로 자릅니다.|
