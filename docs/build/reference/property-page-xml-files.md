...
기본 규칙 폴더에 대 한 경로는 사용 중인 Visual Studio의 로캘 및 버전에 따라 달라 집니다. Visual Studio 2015 또는 이전 개발자 명령 프롬프트에서 rules 폴더는 *`%ProgramFiles(x86)%\MSBuild\Microsoft.Cpp\v4.0\<version>\<locale>`* 입니다. `<version>`이 값은 *`v140`* Visual Studio 2015에 있습니다. 는 `<locale>` LCID (예: 영어의 경우)입니다 `1033` . 설치 된 각 버전의 Visual Studio와 각 언어에 대해 다른 경로를 사용 합니다. 예를 들어, Visual Studio 2015 Community edition의 기본 규칙 폴더 경로는 영어 *`C:\Program Files (x86)\MSBuild\Microsoft.Cpp\v4.0\v140\1033\`* 입니다.

::: moniker-end

::: moniker range="vs-2017"

기본 규칙 폴더에 대 한 경로는 사용 중인 Visual Studio의 로캘 및 버전에 따라 달라 집니다. Visual Studio 2017 개발자 명령 프롬프트에서 rules 폴더는 *`%VSINSTALLDIR%Common7\IDE\VC\VCTargets\<locale>\`* 입니다. 는 `<locale>` LCID (예: 영어의 경우)입니다 `1033` . Visual Studio 2015 또는 이전 개발자 명령 프롬프트에서 규칙 폴더는 이며 *`%ProgramFiles(x86)%\MSBuild\Microsoft.Cpp\v4.0\<version>\<locale>\`* , 여기서 `<version>` 값은 *`v140`* Visual Studio 2015입니다. 설치 된 각 버전의 Visual Studio와 각 언어에 대해 다른 경로를 사용 합니다. 예를 들어, Visual Studio 2017 Community edition의 기본 규칙 폴더 경로는 영어 *`C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\Common7\IDE\VC\VCTargets\1033\`* 입니다.

::: moniker-end

::: moniker range=">=vs-2019"

기본 규칙 폴더에 대 한 경로는 사용 중인 Visual Studio의 로캘 및 버전에 따라 달라 집니다. Visual Studio 2019 이상 개발자 명령 프롬프트에서 규칙 폴더는 이며 *`%VSINSTALLDIR%MSBuild\Microsoft\VC\<version>\<locale>\`* , 여기서 `<version>` 값은 *`v160`* visual Studio 2019입니다. 는 `<locale>` LCID (예: 영어의 경우)입니다 `1033` . Visual Studio 2017에서 rules 폴더는 *`%VSINSTALLDIR%Common7\IDE\VC\VCTargets\<locale>\`* 입니다. Visual Studio 2015 또는 이전 개발자 명령 프롬프트에서 rules 폴더는 *`%ProgramFiles(x86)%\MSBuild\Microsoft.Cpp\v4.0\<version>\<locale>\`* 입니다. 설치 된 각 버전의 Visual Studio와 각 언어에 대해 다른 경로를 사용 합니다. 예를 들어, Visual Studio 2019 Community edition의 기본 규칙 폴더 경로는 영어 *`C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\MSBuild\Microsoft\VC\v160\1033\`* 입니다.
