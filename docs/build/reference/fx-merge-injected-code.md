---
description: 다음에 대 한 자세한 정보:/Fx (삽입 된 코드 병합)
title: /Fx(삽입된 코드 병합)
ms.date: 11/04/2016
f1_keywords:
...
[no_injected_text](../../windows/attributes/no-injected-text.md) 특성이 .mrg 파일에 포함되므로 텍스트를 다시 삽입하지 않고 .mrg 파일을 컴파일할 수 있습니다.
