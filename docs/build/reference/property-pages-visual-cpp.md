---
description: '자세한 정보: Windows c + + 프로젝트 속성 페이지 참조'
...
![C + + 프로젝트의 속성 페이지](media/example-prop-page.png)

이 섹션에서는 속성 페이지 자체에 대 한 빠른 참조를 제공 합니다. 속성 페이지에 표시 되는 옵션 및 설정은 자체 항목에 자세히 설명 되어 있으며 속성 페이지 항목에서 연결 됩니다. 프로젝트 속성에 대 한 자세한 내용은 [Visual Studio에서 c + + 컴파일러 및 빌드 속성 설정](../working-with-project-properties.md)을 참조 하세요.

Linux 프로젝트의 속성 페이지에 대 한 자세한 내용은 [Linux c + + 속성 페이지 참조](../../linux/prop-pages-linux.md)를 참조 하세요.
...
- [관리 되는 리소스 속성 페이지](managed-resources-property-page.md)
